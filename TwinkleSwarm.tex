...
\begin{document}
	...
	The motion of each drone follows a second-order system with velocity saturation and inter-drone repulsion. We present two formulations: the Initial Value Problem (IVP) for time-forward simulation and the Boundary Value Problem (BVP) for trajectory optimization.
